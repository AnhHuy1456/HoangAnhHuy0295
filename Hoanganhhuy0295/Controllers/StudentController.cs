...
namespace Hoanganhhuy0295.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Masinhvien,Hoten,Tuoi")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Masinhvien,Hoten,Tuoi")] Student student)
        {
